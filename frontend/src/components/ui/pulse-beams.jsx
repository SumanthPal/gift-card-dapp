...
export const PulseBeams = () => {
  return (
    <div className="flex h-[40rem] relative items-center justify-center antialiased  overflow-hidden">
        ...
        <div className="relative flex justify-center w-[320px] text-center space-x-2 h-[120px]  items-center z-10 rounded-full py-0.5 px-4  ">
          <span className="md:text-4xl text-base inline-block bg-clip-text text-transparent bg-gradient-to-r ">
            <ConnectWallet />
          </span>
        </div>
      {/* Core SVGs component */}
